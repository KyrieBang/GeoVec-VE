...
def generateResult(data_path, shp_type):
    command = "mpirun -np 2 ../project/build/exp2_fig13-14" + " " + data_path + " " + shp_type
...
def plotFig13(fig_path, total_time_list, speed_list):
    datasets_name = ["P1", "P2", "P3", "P4", "L1", "L2", "A1", "A2"]
...
if __name__ == "__main__":
    ...
    total_time_list[6] = A1_total_time
    speed_list[6] = A1_speed
    ...
    total_time_list[7] = A2_total_time
    speed_list[7] = A2_speed



    # plot the results
    plotFig13("../outputs/simple/fig13/fig13.png", total_time_list, speed_list)

    all_time_df = pd.DataFrame({'P1':P1_time_list, 'P2':P2_time_list, 'P3':P3_time_list, 'P4':P4_time_list, 'L1':L1_time_list, 'L2':L2_time_list, 'A1':A1_time_list, 'A2':A2_time_list})
    plotFig14("../outputs/simple/fig14/fig14.png", all_time_df)