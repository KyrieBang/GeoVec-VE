...
if __name__ == "__main__":
    ...
    P1_type = "point"
    P1_fig_path = "../outputs/simple/fig8/P1.png"
    P1_min_level = 11
    P1_max_level = 16
    ...
    P2_type = "point"
    P2_fig_path = "../outputs/simple/fig8/P2.png"
    P2_min_level = 10
    P2_max_level = 15
    ...
    P3_type = "point"
    P3_fig_path = "../outputs/simple/fig8/P3.png"
    P3_min_level = 7
    P3_max_level = 12
    ...
    P4_type = "point"
    P4_fig_path = "../outputs/simple/fig8/P4.png"
    P4_min_level = 6
    P4_max_level = 11
    ...
    L1_type = "linestring"
    L1_fig_path = "../outputs/simple/fig8/L1.png"
    L1_min_level = 11
    L1_max_level = 16
    ...
    L2_type = "linestring"
    L2_fig_path = "../outputs/simple/fig8/L2.png"
    L2_min_level = 7
    L2_max_level = 12
    ...
    A1_type = "polygon"
    A1_fig_path = "../outputs/simple/fig8/A1.png"
    A1_min_level = 10
    A1_max_level = 15
    ...
    A2_type = "polygon"
    A2_fig_path = "../outputs/simple/fig8/A2.png"
    A2_min_level = 8
    A2_max_level = 13
