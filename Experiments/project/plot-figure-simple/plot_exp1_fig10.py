...
if __name__ == "__main__":
    ...
    L1_type = "linestring"
    L1_fig_path = "../outputs/simple/fig10/L1.png"
    L1_min_len = 200
    L1_max_len = 600
    L1_min_level = 11
    L1_max_level = 16
    ...
    L2_type = "linestring"
    L2_fig_path = "../outputs/simple/fig10/L2.png"
    L2_min_len = 200
    L2_max_len = 600
    L2_min_level = 7
    L2_max_level = 12
    ...
    A1_type = "polygon"
    A1_fig_path = "../outputs/simple/fig10/A1.png"
    A1_min_len = 300
    A1_max_len = 700
    A1_min_level = 10
    A1_max_level = 15
    ...
    A2_type = "polygon"
    A2_fig_path = "../outputs/simple/fig10/A2.png"
    A2_min_len = 300
    A2_max_len = 700
    A2_min_level = 8
    A2_max_level = 13
