...
def generateResult(data_path, shp_type):
    command = "mpirun -np 2 ../project/build/exp3_fig15" + " " + data_path + " " + shp_type
...
def generateGeoSparkViz(data_path, shp_type):
    ...
    command += (f" --conf spark.executor.cores=16")
