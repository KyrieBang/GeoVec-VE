...
if __name__ == "__main__":
    ...
    P1_type = "point"
    P1_fig_path = "../outputs/full/fig9/P1.png"
    P1_min_count = 600
    P1_max_count = 1000
    P1_min_level = 11
    P1_max_level = 16
    ...
    P2_type = "point"
    P2_fig_path = "../outputs/full/fig9/P2.png"
    P2_min_count = 600
    P2_max_count = 1000
    P2_min_level = 10
    P2_max_level = 15
    ...
    P3_type = "point"
    P3_fig_path = "../outputs/full/fig9/P3.png"
    P3_min_count = 600
    P3_max_count = 1000
    P3_min_level = 7
    P3_max_level = 12
    ...
    P4_type = "point"
    P4_fig_path = "../outputs/full/fig9/P4.png"
    P4_min_count = 600
    P4_max_count = 1000
    P4_min_level = 6
    P4_max_level = 11
    ...
    L1_type = "linestring"
    L1_fig_path = "../outputs/full/fig9/L1.png"
    L1_min_count = 600
    L1_max_count = 1000
    L1_min_level = 11
    L1_max_level = 16
    ...
    L2_type = "linestring"
    L2_fig_path = "../outputs/full/fig9/L2.png"
    L2_min_count = 600
    L2_max_count = 1000
    L2_min_level = 7
    L2_max_level = 12
    ...
    # get the subfig results of L3 dataset in fig.9
    L3_path = "../../Datasets/linestring/L3"
    L3_type = "linestring"
    L3_fig_path = "../outputs/full/fig9/L3.png"
    L3_min_count = 600
    L3_max_count = 1000
    L3_min_level = 7
    L3_max_level = 10
    generateResult(L3_path, L3_type, L3_fig_path, "(g) $L_3$", L3_min_count, L3_max_count, L3_min_level, L3_max_level)

    # get the subfig results of A1 dataset in fig.9
    A1_path = "../../Datasets/polygon/A1"
    A1_type = "polygon"
    A1_fig_path = "../outputs/full/fig9/A1.png"
    A1_min_count = 1800
    A1_max_count = 2200
    A1_min_level = 10
    A1_max_level = 15
    ...
    A2_type = "polygon"
    A2_fig_path = "../outputs/full/fig9/A2.png"
    A2_min_count = 1800
    A2_max_count = 2200
    A2_min_level = 8
    A2_max_level = 13
